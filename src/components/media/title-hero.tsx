...
export const TitleHero = ({ details, onPlayTrailer }: TitleHeroProps) => {
  const {
    item,
    status,
    isFavorite,
  ...
  return (
    <section className="relative -mt-16 min-h-[88vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-bg via-bg/20 to-black/45" />
      ...
      <div className="relative mx-auto flex min-h-[88vh] w-full max-w-[1400px] items-end px-4 pb-10 pt-28 sm:px-8 sm:pb-14">
        <div className="grid w-full items-end gap-8 lg:grid-cols-[240px_1fr] xl:grid-cols-[260px_1fr]">
          <div className="title-hero-in relative mx-auto hidden aspect-[2/3] w-full max-w-[240px] overflow-hidden rounded-md bg-surface-2 shadow-[0_28px_70px_rgba(0,0,0,0.62)] lg:block">
            <TmdbImage
