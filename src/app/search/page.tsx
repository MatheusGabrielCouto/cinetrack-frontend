        ...
        <div className="relative mx-auto w-full max-w-[1400px] px-4 pt-10 sm:px-8">
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:items-stretch">
              ...
              <div className="flex gap-2">
                ...
                {(searched || hasFilters || query) && (
                  <Button type="button" size="lg" variant="ghost" onClick={handleClear}>
                    Limpar
                  </Button>
                )}
              </div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              ...
              <span className="mx-1 hidden h-8 w-px self-center bg-line sm:block" />
            ...
            {showAdvanced ? (
              <div className="mt-5 grid gap-3 rounded-xl border border-line bg-surface/80 p-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {!searched && !isLoading ? (
            <section className="mt-12">
              ...
              <p className="mt-1 text-sm text-mute">
                Comece com um perfil pronto e refine depois
              </p>
              <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {QUICK_PRESETS.map((preset) => (
                  <button
                    ...
                    className="group rounded-xl border border-line bg-surface p-4 text-left transition hover:border-mute hover:bg-surface-2"
                  >
                    <span className="block font-semibold text-ink group-hover:text-white">
                      {preset.label}
                    </span>
          ...
          {searched && !isLoading ? (
            <section className="mt-12">
              ...
              {results.length === 0 ? (
                ...
                <div
                  key={enterKey}
                  className="catalog-enter flex flex-wrap gap-3"
                >
                  {results.map((media) => (
                    <MediaPoster
